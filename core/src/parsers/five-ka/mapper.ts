 ...
 *
 * Решения:
 *  - source всегда FIVEKA для этого парсера
 *  - external_code = String(PLU) (PLU 5К — цифры, в БД храним строкой для единообразия)
 *  - КБЖУ на 100г напрямую (5К отдаёт уже на 100г)
 ...
 */
export function mapFiveKaToIngredient(
  product: FiveKaProduct,
  ...
  return {
    name: product.name,
    source: IngredientSource.FIVEKA,
