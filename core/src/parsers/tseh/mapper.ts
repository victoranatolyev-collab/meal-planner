...
/**
 * Маппит сырой TsehProduct в форму, готовую к Prisma upsert в ingredients.
 *
 * Решения:
 *  - source всегда TSEH для этого парсера
 *  - external_code = String(PLU) (PLU TSEH — цифры, в БД храним строкой для единообразия)
 *  - КБЖУ на 100г напрямую (TSEH отдаёт уже на 100г)
 ...
 */
export function mapTsehToIngredient(
  product: TsehProduct,
