...
/**
 * Маппит сырой VvProduct в форму, готовую к Prisma upsert в ingredients.
 *
 * Решения:
 *  - source всегда VV для этого парсера
 *  - external_code = String(PLU) (PLU VV — цифры, в БД храним строкой для единообразия)
 *  - КБЖУ на 100г напрямую (VV отдаёт уже на 100г)
 ...
 */
export function mapVvToIngredient(
  product: VvProduct,
